  ...
  */
  ...
  private void configureBindings() {
    // Schedule `ExampleCommand` when `exampleCondition` changes to `true`
        ...
        */
        m_driverController.axisGreaterThan(4, 0.1).whileTrue(new DefaultArmDrive(m_Arm, m_driverController.getRawAxis(4), "front"));
        m_driverController.axisGreaterThan(3, 0.1).whileTrue(new DefaultArmDrive(m_Arm, -m_driverController.getRawAxis(3), "front"));
